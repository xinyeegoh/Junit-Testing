	...
	// Overview:  a BoundedQueue is a mutable, bounded FIFO data structure
	   ...
	   {  // Modifies: this
	      ...
	      else
	      {
	         ...
	         elements [back] = o; //push element into queue
	         back = (back+1) % capacity; //update back position
	      }
	   }
	   ...
	   {  // Modifies: this
	      ...
	      {
	         size--;
	         Object o = elements [ (front % capacity) ]; //locate
	         elements [front] = null; //pop/remove front element
	         front = (front+1) % capacity;//update front position
	         return o;
	      }
	   }
